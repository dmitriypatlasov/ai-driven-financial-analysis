...
def plot_pdf(continious_states_true, pdf_true, continious_states_rn, pdf_rn):
    """
    ...
    ax.plot(continious_states_true, pdf_true, color='skyblue', linewidth=2, label='Физическая PDF')
    ax.plot(continious_states_rn, pdf_rn, color='orange', linewidth=2, label='Риск-нейтральная PDF')
