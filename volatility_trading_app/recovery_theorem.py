...
def plot_pdf(continious_states_true, pdf_true, continious_states_rn, pdf_rn):
    ...
    ax.plot(continious_states_true, pdf_true, color='purple', linewidth=2, label='True PDF')
    ax.plot(continious_states_rn, pdf_rn, color='coral', linewidth=2, label='Risk-neutral PDF')
